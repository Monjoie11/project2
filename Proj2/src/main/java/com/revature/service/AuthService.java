...
public class AuthService {
	...
	public Object validateEntity(String email, String password) {
		...
		/*
		 * User validatedUser = new User("angularTest@tes.com", "angularTest",
		 * "angular", "test", "800-ang-ular", null,
		 * "once upon a time there was angular", "angular is hard", null, null, 5.0,
		 * User.AccessLevel.OPEN, User.WorkType.BACKHOUSE);
		 * 
